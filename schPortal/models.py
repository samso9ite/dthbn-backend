...
class Indexing(models.Model):
    ...
    referee_phone = models.CharField(max_length=200, blank=True, null=True)  
    referee_name_0 = models.CharField(max_length=200, blank=True, null=True) 
    referee_address_1 = models.CharField(max_length=200, blank=True, null=True)  
    referee_phone_2 = models.CharField(max_length=200, blank=True, null=True)  
    marriage_cert = models.ImageField(upload_to='images/indexing/marriage_cert', null=True, blank=True)
    o_level_cert_1 = models.ImageField(upload_to='images/OlevelResult',  null=True, blank=True)
    o_level_cert_2 = models.ImageField(upload_to='images/OlevelResult',  null=True, blank=True)
